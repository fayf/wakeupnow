...
public class ListAlertsActivity extends ListActivity{
	private static final String[] FROM = {DBHelper.KEY_ID, DBHelper.KEY_RADIUS, DBHelper.KEY_SNIPPET, DBHelper.KEY_LATITUDE, DBHelper.KEY_LONGITUDE, DBHelper.KEY_EXPIRY};
